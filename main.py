...
def main():
    ...
    parser.add_argument('--init_method', default='tcp://10.0.102.25:6666', type=str, help='')
    ...
    if args.local_rank == -1 or args.no_cuda:
        ...
        torch.distributed.init_process_group(backend='nccl', init_method=args.init_method, world_size=args.world_size, rank=args.rank)
        if args.fp16:
